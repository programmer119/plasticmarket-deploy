import { d as ensure_array_like, c as attr, b as escape_html, f as attr_class, k as derived } from './index.js-DDNhq7BZ.js';
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		let sort = "Featured";
		let q = data.initialQuery;
		let grade = "All";
		let listingOnly = false;
		const cats = ["All", ...new Set(data.products.map((p) => p.category))];
		const grades = ["All", ...new Set(data.products.map((p) => p.grade))];
...
//# sourceMappingURL=_page.svelte-CA5qQgSi.js.map
