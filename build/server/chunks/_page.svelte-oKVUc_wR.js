import { d as ensure_array_like, b as escape_html, f as attr_class, k as derived } from './index.js-B1-lYwNB.js';
import { P as ProductCard } from './ProductCard-BER9t_RO.js';
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		let tab = data.entries.some((x) => x.entry.status === "Owned") ? "Owned" : statuses.find((s) => data.entries.some((x) => x.entry.status === s)) || "Owned";
...
//# sourceMappingURL=_page.svelte-oKVUc_wR.js.map
