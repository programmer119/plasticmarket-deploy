import { f as attr_class, c as attr, d as ensure_array_like, b as escape_html, k as derived } from './index.js-DDNhq7BZ.js';
import { p as products, k as krw, m as money } from './catalog-eJPybn3p.js';
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		let { data } = $$props;
		let q = "";
		let selected = products.find((p) => p.slug === data.product) || products[0];
...
//# sourceMappingURL=_page.svelte-BVqhEUxz.js.map
