...
async function get_hooks() {
	...
	let init;
	({handle, handleFetch, handleError, handleValidationError, init} = await import('./hooks.server-CbkpD_Wx.js'));
	let reroute;
	let transport;
	return {
		handle,
...
export { SvelteKitError as S, Server as a, escape_html as b, attr as c, attr_class as d, error as e, ensure_array_like as f, getContext as g, head as h, index_server_exports as i, json as j, derived as k, noop as n, private_env as p, redirect as r, splitCookiesString as s };
//# sourceMappingURL=index.js-BXRNCAzq.js.map
