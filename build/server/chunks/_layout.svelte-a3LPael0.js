import { h as head, b as escape_html, c as attr } from './index.js-B1-lYwNB.js';
import './client-DjEOU_Vc.js';
...
function _layout($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<!--]--></nav></div> <div class="subnav"><div class="shell"><a href="/browse?category=Gunpla">Gunpla</a><a href="/browse?category=Figures">Figures</a><a href="/browse?category=Character%20Kits">Character Kits</a><a href="/browse?category=Cars">Cars</a><a href="/browse?view=new">${escape_html(t("newReleases"))}</a><a href="/browse?view=preorder">${escape_html(t("preorders"))}</a><span class="locale-controls">`);
		$$renderer.select({
...
//# sourceMappingURL=_layout.svelte-a3LPael0.js.map
