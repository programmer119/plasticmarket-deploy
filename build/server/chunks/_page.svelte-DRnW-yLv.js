import { b as escape_html, d as ensure_array_like, f as attr_class, c as attr } from './index.js-In7hBQ7y.js';
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		let tab = data.initialTab || "Inventory";
		...
		if (tab === "Inventory") {
			...
			if (orders.length) {
				...
				for (let $$index_2 = 0, $$length = each_array_2.length; $$index_2 < $$length; $$index_2++) {
					...
					if (o.status === "PAID") {
						$$renderer.push("<!--[0-->");
						$$renderer.push(`<button class="btn">Mark shipped</button>`);
					} else {
						$$renderer.push("<!--[-1-->");
			...
			if (offers.length) {
				...
				for (let $$index_3 = 0, $$length = each_array_3.length; $$index_3 < $$length; $$index_3++) {
					...
					if (o.status === "OPEN") {
						$$renderer.push("<!--[0-->");
						$$renderer.push(`<button class="btn dark">Accept</button><button class="btn">Decline</button>`);
					} else {
						$$renderer.push("<!--[-1-->");
...
//# sourceMappingURL=_page.svelte-DRnW-yLv.js.map
